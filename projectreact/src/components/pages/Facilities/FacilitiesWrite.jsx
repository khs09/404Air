      ...
      <div className="table-wrap rounded mt-5">
        <form onSubmit={submitData} method="post">
          <Row className="mb-3">
            ...
            <Col>
              <strong>시설명</strong>
              <Form.Control name="facilityName" placeholder="시설명 입력..." max={255} value={formData.facilityName} onChange={formDataHandler} />
            </Col>
            <Col>
          ...
          <Row className="mb-3">
            <Col>
              <strong>시설위치</strong>
              <Form.Control name="facilityLocation" value={address} placeholder="위치 입력..." onClick={daumAPI} onChange={formDataHandler} readOnly required />
            </Col>
          </Row>
          <Row className="mb-3">
            <Col>
...
export default FacilitiesWrite;
